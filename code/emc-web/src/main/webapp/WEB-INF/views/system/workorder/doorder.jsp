...
<div class="wrapper wrapper-content">
    <div class="row col-sm-12 col-xs-12 col-md-12 col-lg-12">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="workDoForm" dic="form">
                ...
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red"></span>完成原因：</label>
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <textarea content="content" id="finishReason" name="finishReason" class="form-control inputs-lg" rows="3" cols="20"  type="text" maxlength="512" placeholder="请输完成原因"></textarea>
                    </div>
                </div>
...
<script>
    ...
    //以下为官方示例
    $(function () {
        var $form = $(top.document).find("#workDoForm");
        ...
        $form.validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    url: _web + '/work/order/info/done/order',
                    data: $form.serialize(),
                    type: 'POST',
                    dataType: 'json',
