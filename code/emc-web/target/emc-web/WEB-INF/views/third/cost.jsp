...
<head>
    ...
    <script src="${web}/script/huak.web.third.cost.js"></script>
</head>
<body>
    ...
    <div class="col-lg-12 mb14  ">
        <div class=" index_contentBox clearfix">
            <div class="titbox clearfix no-padding no-margin">
                <div class="pull-left groupEnergyTit energyTit"><i></i><span class="maintitle"></span>明细<small class="font-sm">COST CONTROL DETAILS</small></div>
            </div>
            <div class="groupEnergy-box col-lg-12  clearfix">
                <div class="chart-box groupEnergy-chart col-lg-10 ">
                    <div class="cb-header">
                        <span class="cb-title">集团总成本 (单位: 万元)</span>
            ...
            <div class="clearfix energy-list col-lg-12 ">
                <div class="energy-list-box energy-list-box-first">
                    <div class="energy-head energy-add">
                        <span class="energy-list-name">源-<span class="maintitle"></span></span>
                ...
                <div class="energy-list-box">
                    <div class="energy-head ">
                        <span class="energy-list-name">网-<span class="maintitle"></span></span>
                        <div class="energy-list-info">
                            <span class="energy-list-num">0</span>
                            <span class="energy-list-measure ">万元</span>
                            <span class="energy-list-proportion ">(0)</span>
                ...
                <div class="energy-list-box">
                    <div class="energy-head ">
                        <span class="energy-list-name">站-<span class="maintitle"></span></span>
                        <div class="energy-list-info">
                            <span class="energy-list-num">0</span>
                            <span class="energy-list-measure ">万元</span>
                            <span class="energy-list-proportion ">(0)</span>
                ...
                <div class="energy-list-box">
                    <div class="energy-head ">
                        <span class="energy-list-name">线-<span class="maintitle"></span></span>
                        <div class="energy-list-info">
                            <span class="energy-list-num">0</span>
                            <span class="energy-list-measure ">万元</span>
                            <span class="energy-list-proportion ">(0)</span>
                ...
                <div class="energy-list-box energy-list-box-last">
                    <div class="energy-head ">
                        <span class="energy-list-name">户-<span class="maintitle"></span></span>
                        <div class="energy-list-info">
                            <span class="energy-list-num">0</span>
                            <span class="energy-list-measure ">万元</span>
                            <span class="energy-list-proportion ">(0)</span>
            ...
            <div class="AssessmentBox rconttable col-lg-12 no-padding">
                ...
                <div class="col-lg-12 no-padding mt30">
                    <div class="col-lg-6 no-padding analyBoxList">
                        <div class="ec_title">
                            换热站<span class="maintitle">-成本</span>排名
                        </div>
                    ...
                    <div class="col-lg-6 no-padding analyBoxList analyBoxline">
                        <div class="ec_title">
                            热源<span class="maintitle">-成本</span>排名
                        </div>
...
<div class="index_contentBox clearfix">
<div class="titbox clearfix no-padding no-margin">
<div class="clearfix pull-left energyTit analy_tit_as"><i></i><span class="maintitle">-费用成本</span>明细<small class="font-sm">Cost Control details</small></div>
