...
<div class="wrapper wrapper-content">
    <div class="row col-sm-12 col-xs-12 col-md-12 col-lg-12">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="alarmConfigTempAddForm" dic="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="mintemp" id="mintemp" class="form-control inputs-lg" type="text" maxlength="16" placeholder="请输入最低温度">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="maxtemp" id="maxtemp" class="form-control inputs-lg" type="text" maxlength="16" placeholder="请输入最低温度">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
...
<script>
    ...
    //以下为官方示例
    $(function () {
        var $form = $(top.document).find("#alarmConfigTempAddForm");
        ...
        $form.validate({
            ...
            messages: {
                ...
                mintemp: {
                    required: icon + "请输入最低温度"
                },
                maxtemp: {
                    required: icon + "请输入最高温度"
                },
                isenable: {
