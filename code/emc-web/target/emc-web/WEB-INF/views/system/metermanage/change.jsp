            ...
            <form class="form-horizontal" id="meterDataChangeForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class=" col-sm-7  col-xs-7 col-md-7 col-lg-7">
                        <input name="name"   class="form-control" value="${mec.name}"  type="hidden" maxlength="16">
                        <input name="name"   class="inputs-lg form-control" value="${mec.name}" disabled type="text" maxlength="16" placeholder="请输入计量名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class=" col-sm-7  ">
                        <input id="start" type="text"  class="laydate-icon  form-control layer-date inputs-lg"  name="changeTime"
                ...
                <div class="form-group">
                    ...
                    <div class=" col-sm-7  col-xs-7 col-md-7 col-lg-7">
                        <input name="usedCoef"  class="form-control inputs-lg" value="${mec.coef}" type="text" maxlength="16" placeholder="请输入旧计量系数">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class=" col-sm-7  col-xs-7 col-md-7 col-lg-7">
                        <input name="newNum" class="form-control inputs-lg" value="" type="text" maxlength="16" placeholder="请输入新计量表底">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class=" col-sm-7  col-xs-7 col-md-7 col-lg-7">
                        <input name="newCoef" id="code" class="form-control inputs-lg" value="" type="text" maxlength="16" placeholder="请输入新计量系数">
                    </div>
                </div>
            </form>
        </div>
