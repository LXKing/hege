    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="secondnetEditForm" role="form">
                ...
                <input type="hidden" name="comId" id="comId" value="${secondnet.comId}">
                <input type="hidden" name="lineNameOld" id="lineNameOld" value="${secondnet.lineName}">
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red">*</span>管线名称：</label>

                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="lineName" id="lineName" class="form-control" type="text" value="${secondnet.lineName}" maxlength="16" placeholder="请输入管线名称">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="lineCode" id="lineCode" class="form-control" type="text" value="${secondnet.lineCode}" maxlength="16" placeholder="请输入管线代码">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        ...
                        <select id="netTypeId" name="netTypeId" class="chosen-select form-control">
                            <c:forEach items="${sysdic}" var="item" varStatus="status" >
                                <option  ${secondnet.netTypeId eq item.seq?'selected':''}  value="${item.seq}">${item.des}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    $(function () {
        ...
        var $form = $(top.document).find("#secondnetEditForm");
