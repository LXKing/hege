                        ...
                        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                            <form class="form-horizontal" id="addForm" role="form">
                                ...
                                <div class="form-group">
                                    <div class="td">
                                        <label class="col-sm-3 col-xs-3 col-md-3 col-lg-3  control-label">机构名称：</label>
                                        <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                            <input id="orgName" readonly class="form-control" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="td">
                                        <label class="col-sm-3 col-xs-3 col-md-3 col-lg-3  control-label">序号：</label>
                                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                            <input id="sort"  readonly class="form-control" type="text">
                                        </div>
                                    </div>
                                </div>
                                <%--<div class="form-group">--%>
