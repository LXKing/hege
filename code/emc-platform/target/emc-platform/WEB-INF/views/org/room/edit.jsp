...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="roomEditForm" role="form">
                ...
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <input name="roomName" value="${room.roomName }" class="form-control" type="text" maxlength="16" placeholder="请输入户名称">
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <input value="${room.roomCode }" name="roomCode" class="form-control" type="text" maxlength="16" placeholder="请输入户编码">
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <input value="${room.heatArea }" name="heatArea" class="form-control" type="text" maxlength="16" placeholder="请输入供热面积">
	                    </div>
	                </div>
                </div>
                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
                ...
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                   <label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 control-label"><span class="red">*</span>所属公司：</label>
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <select disabled="disabled" onchange="getCommunityAndLineSelectHtml()" value="${room.comId }" id="comId" name="comId" class="form-control m-b" ></select>
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                    	<ul id="org" light="${room.orgId }" value="${room.orgId }" class="room-edit-org-tree" style="height: 200px;overflow-y:scroll;border: 1px solid #E5E6E7;"></ul>
	                    	<input type="text" value="${room.orgId }" class="form-control" name="orgId" id="orgId" style="visibility: hidden;height: 0px;">
	                    </div>
		            </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <select onclick="addLine()" id="lineId" name="lineId" class="form-control m-b" value="${room.lineId }" ></select>
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <select onclick="addCommunity()" onchange="getBanSelectHtml()" value="${room.communityId }" id="communityId" name="communityId" class="form-control m-b" ></select>
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <select onclick="addBan()" onchange="getSelectHtml()" value="${room.banId }" id="banId" name="banId" class="form-control m-b" ></select>
	                    </div>
	                </div>
                </div>
                <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                        <select onclick="addCell()" value="${room.cellId }" id="cellId" name="cellId" class="form-control m-b" ></select>
	                    </div>
	                </div>
                </div>
            </form>
