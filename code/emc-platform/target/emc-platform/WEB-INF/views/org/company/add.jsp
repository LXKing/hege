...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="companyAddForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input id="cname" name="cname" class="form-control" type="text" maxlength="32"
                               placeholder="请输入公司名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="nextDes" class="form-control" type="text" maxlength="16"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="tableName" class="form-control" type="text" maxlength="64" value="t_emc_final_data_hour_"
                               placeholder="请输入数据表名">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select id="weatherType" name="weatherType" class="chosen-select form-control"  >
                            ...
                            <option value="2">气象节点</option>
                        </select>
                    </div>
                </div>
                <div class="form-group" id="weatherP" style="display: none;">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select id="weatherPs" name="weatherPs" class="chosen-select form-control"  >
                            ...
                            <c:forEach items="${cites}" var="city">
                                <option value="${city.W_CODE}">${city.W_NAME}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                <div class="form-group" id="weatherC" style="display: none;">
                ...
                <div class="form-group" id="weatherT" style="display: none;">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
...
<script>
    ...
    //以下为官方示例
    $(function () {
        var $form = $(top.document).find("#companyAddForm");
