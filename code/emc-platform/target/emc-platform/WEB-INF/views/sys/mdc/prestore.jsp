        ...
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="meterCollectPrestoreForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="start" type="text"  class="laydate-icon  form-control layer-date"  name="prestoreTime"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="prestoreNum" id="code" class="form-control" value="" type="text" maxlength="16" placeholder="请输入预存值">
                    </div>
                </div>
            </form>
        </div>
