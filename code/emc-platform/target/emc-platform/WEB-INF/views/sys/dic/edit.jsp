...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="dicEditForm" dic="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="des" class="form-control" type="text" maxlength="8" value="${sysDic.des}"
                               placeholder="请输入字典名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="seq" class="form-control" type="text" value="${sysDic.seq}" maxlength="4" placeholder="请输入排序">
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    //以下为官方示例
    $(function () {
        var $form = $(top.document).find("#dicEditForm");
