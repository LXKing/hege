...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="energyTypeEditForm" role="form">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="id" value="${energyType.id}">
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red">*</span>类型名称(中文)：</label>

                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="nameZh" class="form-control" type="text" maxlength="8" value="${energyType.nameZh}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="nameEn" class="form-control" value="${energyType.nameEn}" type="text" maxlength="16" placeholder="请输入类型名称(英文)">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select name="type" class="chosen-select form-control">
                            ...
                            <c:forEach items="${sysDic['energyType']}" var="type">
                                <option ${energyType.type eq type.seq?'selected':''} value="${type.seq}">${type.des}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select name="ecoType" class="chosen-select form-control">
                            ...
                            <c:forEach items="${sysDic['energyEcoType']}" var="type">
                                <option ${energyType.ecoType eq type.seq?'selected':''} value="${type.seq}">${type.des}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="dosageUnit" class="form-control" value="${energyType.dosageUnit}" type="text" maxlength="16" placeholder="请输入用量单位">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="price" class="form-control" value="${energyType.price}" type="text" maxlength="10" placeholder="请输入默认单价(元)">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="coef" class="form-control" value="${energyType.coef}" type="text" maxlength="10" placeholder="请输入标煤系数">
                    </div>
                </div>
            </form>
        </div>
    ...
    $(function () {
        ...
        $form.validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    url: _platform + '/energy/type/edit',
                    data: $form.serialize(),
                    type: 'POST',
                    dataType: 'json',
                    success: function (result) {
