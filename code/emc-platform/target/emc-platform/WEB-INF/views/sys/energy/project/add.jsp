...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="energyProjectAddForm" role="form">
               <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                    	<ul id="org" class="energyProject-add-org-tree" style="height: 200px;overflow-y:scroll;border: 1px solid #E5E6E7;"></ul>
               ...
               <div class="row">
	                <div class="form-group" style="width:100%;float: left;margin-right: 0px;">
	                    ...
	                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
	                    	<input id="num" name="num" class="form-control m-b" >
	                    </div>
		            </div>
                </div>
            </form>
...
<script>
    ...
    function treeNodeClick(){
        var nodes = epAddTree.getSelectedNodes();
    ...
    $(function () {
    	...
    	//获取表单元素
     	var $form = $(top.document).find("#energyProjectAddForm");
        ...
        $form.validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    url: _platform + '/energy/project/add',
                    data: $form.serialize(),
                    type: 'POST',
                    dataType: 'json',
