...
<script>
    ...
    $(function () {
        ...
        submitHandler:function(){
            ...
            alert(data);
            $.ajax({
                    url:_platform + '/active/addnodevalue',
        ...
        <div class="col-sm-12">
            <form class="form-horizontal" id="activeTreeAddForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="admCode" name="admCode" class="form-control orgNameID" type="text" maxlength="12" placeholder="请输入行政代码">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  control-label"><span class="red">*</span>区划名称：</label>
                    <div class="col-sm-8">
                        <input id="admName" name="admName" class="form-control orgNameID" type="text" maxlength="18" placeholder="请输入行政区划名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="lng" name="lng" class="form-control" type="text" maxlength="8" placeholder="请输入经度">
                    </div>
                </div>
                <div class="form-group">
                <label class="col-sm-3  control-label"><span class="red"></span>纬度：</label>
                <div class="col-sm-8">
                    <input id="lat" name="lat" class="form-control orgNameID" type="text" maxlength="8" placeholder="请输入纬度">
                </div>
            </div>
