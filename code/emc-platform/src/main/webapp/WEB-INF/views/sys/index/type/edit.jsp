...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="indexTypeEditForm" role="form">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="id" value="${indexType.id}">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select name="energyType" class="chosen-select form-control">
                            ...
                            <c:forEach items="${sysDic['energyType']}" var="type">
                                <option ${indexType.energyType eq type.seq?'selected':''} value="${type.seq}">${type.des}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <select name="unitType" class="chosen-select form-control">
                            ...
                            <c:forEach items="${sysDic['orgType']}" var="type">
                                <option ${indexType.unitType eq type.seq?'selected':''} value="${type.seq}">${type.des}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="name" class="form-control" type="text" maxlength="8" value="${indexType.name}"
                               placeholder="请输入类型名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="unitMeter" class="form-control" value="${indexType.unitMeter}" type="text" maxlength="32" placeholder="请输入用量单位">
                    </div>
                </div>
...
<script>
    ...
    //以下为官方示例
    $(function () {
        var $form = $(top.document).find("#indexTypeEditForm");
        // validate signup form on keyup and submit
        var icon = "<i class='fa fa-times-circle'></i> ";

        $.validator.addMethod("checkName", function (value, element) {
            if(value =='${indexType.name}'){
                return true;
            }
