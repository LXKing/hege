            ...
            <form class="form-horizontal" id="meterCollectChangeForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="name" readonly  class="form-control" value="${mec.name}" type="text" maxlength="16" placeholder="请输入计量名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select id="unitId" disabled name="unitId" class="chosen-select-unit form-control" >
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><span class="red">*</span>换表时间：</label>
                    <div class="col-sm-8">
                        <input id="start" type="text"  class="laydate-icon  form-control layer-date"  name="changeTime"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="usedNum" class="form-control" value="" type="text" maxlength="16" placeholder="请输入旧计量表底">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red">*</span>旧计量系数：</label>
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="usedCoef"  class="form-control" value="${mec.coef}" type="text" maxlength="16" placeholder="请输入旧计量系数">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red">*</span>新计量表底：</label>
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="newNum" class="form-control" value="" type="text" maxlength="16" placeholder="请输入新计量表底">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                            class="red">*</span>新计量系数：</label>
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="newCoef" id="code" class="form-control" value="" type="text" maxlength="16" placeholder="请输入新计量系数">
                    </div>
                </div>
            </form>
        </div>
