            ...
            <form class="form-horizontal" id="costTypeEditForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="nameZh" class="form-control" type="text" maxlength="8" value="${costType.nameZh}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="nameEn" class="form-control" value="${costType.nameEn}" type="text" maxlength="16" placeholder="请输入类型名称(英文)">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3  col-xs-3 col-md-3 col-lg-3 control-label"><span
                    ...
                    <div class="col-sm-8  col-xs-8 col-md-8 col-lg-8">
                        <input name="dosageUnit" class="form-control" value="${costType.dosageUnit}" type="text" maxlength="16" placeholder="请输入用量单位">
                    </div>
                </div>
            </form>
        </div>
