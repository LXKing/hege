...
//以下为官方示例
$(function () {
    var $form = $(top.document).find("#feed_add_Form");
            ...
            <div class="ibox float-e-margins">
                    <form class="form-horizontal" id="feed_add_Form" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="feedName" id="feedName" class="form-control" type="text" maxlength="64" placeholder="请输入热源名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="td">
